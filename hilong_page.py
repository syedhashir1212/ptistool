...
def fetch_data_from_db(search_by=None, search_value=None, after_date=None, show_all=False):
    ...
    if show_all:
        ...
        WHERE Customer IN ('HOS&EP(L', 'HOS&EP(L).','HOS&EPL','HOS&EW','HO&ESP', 'HO&ES', 'HOS&EP(L).', 'HOS&EP', 'HOS&EP(L','H','HOS', 'HOGS&EP')
        """
        params = ()
        ...
        SELECT * FROM inspections
        WHERE {search_by} > ?
        AND Customer IN ('HOS&EP(L', 'HOS&EP(L).','HOS&EPL','HOS&EW','HO&ESP', 'HO&ES', 'HOS&EP(L).', 'HOS&EP', 'HOS&EP(L','H','HOS', 'HOGS&EP')
